...
Independent static website project for a premium Florida exterior coating brand.

## Local Preview

Run `node server.js` from this folder and open `http://127.0.0.1:4178`.

## Deployment

The local version references the project image at `assets/florida-home-exterior.png`. If deploying through a text-only GitHub connector, use a hosted image URL or upload the image asset through GitHub/Netlify directly.
